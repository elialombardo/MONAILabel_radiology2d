...
def main():
    ...
    studies = '/workspace/images/contoured_AI_assisted/2023_05_05_all_sites/pancreas_patient0001/raw_cine/20210317105210_converted_output_scan_6_2D_rad_FOV270_8FPS_th5_sag'
    
    # model = "localization_spine,localization_vertebra,segmentation_vertebra"
...
if __name__ == "__main__":
    ...
    check_loading = False
    if check_loading:
        # Check transforms, shapes etc.
        paths_dict = [{"image": "/workspace/images/contoured_AI_assisted/2023_05_05_all_sites/pancreas_patient0001/raw_cine/20210317105210_converted_output_scan_6_2D_rad_FOV270_8FPS_th5_sag/frame_00011.nii.gz",
                        "label": "/workspace/images/contoured_AI_assisted/2023_05_05_all_sites/pancreas_patient0001/raw_cine/20210317105210_converted_output_scan_6_2D_rad_FOV270_8FPS_th5_sag/labels/final/frame_00011.nii.gz"}, 
                        {"image": "/workspace/images/contoured_AI_assisted/2023_05_05_all_sites/pancreas_patient0001/raw_cine/20210317105210_converted_output_scan_6_2D_rad_FOV270_8FPS_th5_sag/frame_00011.nii.gz",
                        "label": "/workspace/images/contoured_AI_assisted/2023_05_05_all_sites/pancreas_patient0001/raw_cine/20210317105210_converted_output_scan_6_2D_rad_FOV270_8FPS_th5_sag/labels/final/frame_00011.nii.gz"}
                    ]
        ...
        train_transforms = Compose([
                ...
                EnsureChannelFirstd(keys=("image")),  # images are saves as (270,270)
                EnsureChannelFirstd(keys=("label"), channel_dim=-1),  # albels get saved with shape (270,270,1)
